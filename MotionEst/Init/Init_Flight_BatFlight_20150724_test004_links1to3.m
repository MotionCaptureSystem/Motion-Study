function [camstruct,options] = Init_Flight_BatFlight_20150724_test004_links1to3(camstruct,options)
%% --------------------------Set Options----------------------------------
%Import Options
...
options.est.state_init      = [360,1074,-307,90*pi/180,-100*pi/180,180*pi/180,...%]';%,...
