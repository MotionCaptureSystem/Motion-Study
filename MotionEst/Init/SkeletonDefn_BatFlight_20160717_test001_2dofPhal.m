...
NodeNames   = {'BB_1'       ,   [] ,   [2,3],          [],               1,      'DH';        %1
               ...
               'LD4Met'     ,   [12],  [],             [1],              3,      'DH';        %14
               'LD5Met'     ,   [12],  [],             [1],              3,      'DH';        %15
               'LD3Phal1'   ,   [13],  [20],           [1],              4,      'DH';        %16 %%%%%%%%%%%
               'LD4Phal1'   ,   [14],  [21],           [1],              4,      'DH';        %17
               'LD5Phal1'   ,   [15],  [22],           [1],              4,      'DH';        %18
               'RD3Phal1'   ,   [9],   [23],           [1],              4,      'DH';        %19 %%%%%%%%%%%
               'RD4Phal1'   ,   [10],   [24],           [1],              4,      'DH';        %20
               'RD5Phal1'   ,   [11],  [25],           [1],              4,      'DH';        %21
               'LD3Phal2'   ,   [16],  [],             [1],              5,      'DH';        %22
               'LD4Phal2'   ,   [17],  [],             [1],              5,      'DH';        %23
               'LD5Phal2'   ,   [18],  [],             [1],              5,      'DH';        %24
               'RD3Phal2'   ,   [19],  [],             [1],              5,      'DH';        %25
               'RD4Phal2'   ,   [20],  [],             [1],              5,      'DH';        %26
               'RD5Phal2'   ,   [21],  [],             [1],              5,      'DH'};       %27
...
synthConfig.link(9).pt_nums = [47,54,87];
synthConfig.link(10).pt_nums = [41,56,87];
synthConfig.link(11).pt_nums = [44,58,87];

synthConfig.link(12).pt_nums = [174,174];
synthConfig.link(13).pt_nums = [208,212,174];
synthConfig.link(14).pt_nums = [190,192,174];
synthConfig.link(15).pt_nums = [167,170,174];

synthConfig.link(16).pt_nums = [203,208];
synthConfig.link(17).pt_nums = [188,190];
synthConfig.link(18).pt_nums = [166,167];
synthConfig.link(19).pt_nums = [37,47];
synthConfig.link(20).pt_nums = [21,41];
synthConfig.link(21).pt_nums = [25,44];

synthConfig.link(22).pt_nums = [201,203];
synthConfig.link(23).pt_nums = [187,188];
synthConfig.link(24).pt_nums = [165,166];
synthConfig.link(25).pt_nums = [1,37];
synthConfig.link(26).pt_nums = [4,21];
